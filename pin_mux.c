...
void BOARD_InitPins(void) {                                /*!< Function assigned for the core: Cortex-M4[m4] */
    ...
    IOMUXC_SetPinMux(IOMUXC_SAI3_RXC_SAI3_RX_BCLK, 0U);
    IOMUXC_SetPinConfig(IOMUXC_SAI3_RXC_SAI3_RX_BCLK, 
                        IOMUXC_SW_PAD_CTL_PAD_DSE(2U) |
                        IOMUXC_SW_PAD_CTL_PAD_FSEL(2U) |
                        IOMUXC_SW_PAD_CTL_PAD_HYS_MASK);
    IOMUXC_SetPinMux(IOMUXC_SAI3_RXD_SAI3_RX_DATA0, 0U);
    IOMUXC_SetPinConfig(IOMUXC_SAI3_RXD_SAI3_RX_DATA0, 
                        IOMUXC_SW_PAD_CTL_PAD_DSE(2U) |
                        IOMUXC_SW_PAD_CTL_PAD_FSEL(2U) |
                        IOMUXC_SW_PAD_CTL_PAD_HYS_MASK);
    IOMUXC_SetPinMux(IOMUXC_SAI3_RXFS_SAI3_RX_SYNC, 0U);
    IOMUXC_SetPinConfig(IOMUXC_SAI3_RXFS_SAI3_RX_SYNC, 
                        IOMUXC_SW_PAD_CTL_PAD_DSE(2U) |
                        IOMUXC_SW_PAD_CTL_PAD_FSEL(2U) |
                        IOMUXC_SW_PAD_CTL_PAD_HYS_MASK);
